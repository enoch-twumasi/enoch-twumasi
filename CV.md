...
Springfield, MO • (573) 202-0088 • [enochatb@gmail.com](mailto:enochatb@gmail.com)  
[LinkedIn](https://linkedin.com/in/enoch-twumasi) • [GitHub](https://github.com/enoch-twumasi/enoch-twumasi) • [Portfolio](https://firstlastdev.com/#founder)
...
### First and Last | Founder & Lead Engineer
...
*   **Royal Blue Bullies:** Built a high-performance lead-generation platform achieving perfect 100 SEO and Accessibility scores on PageSpeed Insights. Automated client education via interactive logic tools, generating 40–50 verified daily leads and driving total inventory sell-out within 72 hours.
*   **RBAC-Enforced Career Platform:** Engineered a secure, role-based application for enterprise recruitment. Implemented complex state modeling, multi-tenant data isolation, and server-side mutations using React Actions to enforce strict permission boundaries.

## Operational & Real-World Execution

### Indian Summer Pool | Springfield, MO
**Contractor, Technician & Domain Consultant**
*   Executed complex physical installations, maintenance, and plumbing repairs on commercial and residential filtration systems, ensuring precise chemical balancing and strict safety compliance.
*   Leveraged hands-on, domain-specific field knowledge to accurately scope, design, and architect the company’s digital infrastructure and local search ecosystem.

### Missouri University of Science and Technology | Rolla, MO
**STEM Educator & Technical Tutor — Kummer Center for STEM Education**
*   Delivered technical instruction to K-12 students, translating complex scientific and engineering concepts into accessible learning models.
*   Managed technical inventory and organized operational logistics for Project Lead The Way (PLTW) events in collaboration with university faculty.

### Tekniplex & Healthcare Services | Tacoma, WA
**Industrial Machine Operator & Clinical Care Aide**
*   **Industrial Operations:** Operated, maintained, and troubleshooted advanced mechanical and digital manufacturing equipment, upholding rigid safety and quality standards to minimize downtime.
*   **Clinical Care:** Provided dedicated healthcare support to high-needs patients (including Dementia care), maintaining strict medical protocols and high reliability in sensitive environments.

### Kwame Nkrumah University of Science and Technology | Kumasi, Ghana
**Radiology Assistant & Rural Health Team Member**
*   Managed patient intake, reporting, and billing for clinical CT procedures within the university Radiology Department.
*   Deployed with the GNAAS Health Team to provide secondary healthcare services, emergency first aid, and OTC administration to underserved rural communities.

### Additional Operational Roles
*   **Live Event AV & Streaming Technician (National Seminars):** Executed live, nationwide streaming for large-scale seminar events, ensuring zero-downtime broadcasting and high-fidelity AV routing.
*   **Campus Security Officer (Missouri S&T Police Dept):** Patrolled campus infrastructure, monitored secure access points, and enforced safety protocols with a high degree of situational awareness.
*   **Logistics & Inventory Coordinator (Healthy Planet / Wellness Wagon):** Managed B2B/B2C dynamic stock replenishment, inventory tracking, and order staging logistics.
...
*   Bachelor of Science in Biological Sciences – Pre-Medicine Emphasis (May 2023)
*   *Honors:* Provost’s International Scholarship Recipient
*   *Advanced Coursework:* Advanced Layout & Design (Master’s level coursework architecting complex digital/print layouts).

**Kwame Nkrumah University of Science and Technology (KNUST) | Kumasi, Ghana**
*   Bachelor of Science in Forest Resources Technology – Ecotourism Specialty (Sept 2022)
...
*   **Multilingual Fluency:** English, French, Spanish, Twi, and Fante.
*   **Scientific Communication:** Delivered formal academic presentations on Regional/Global Climate Change (KNUST, 2019) and Climatology/Climate Science (North American Division, Ozarks, MO, 2024).
*   **Organizational Leadership:** Media Officer for the International Students Club and the African Student Association at Missouri S&T, managing digital outreach.
*   **Debate & Public Speaking:** Competitive Member of the KNUST Debate Society, trained in rapid analytical thinking and persuasive argumentation.
*   **Greek Life:** Member of Pi Kappa Phi Fraternity, Gamma Lambda Chapter (Missouri S&T).
